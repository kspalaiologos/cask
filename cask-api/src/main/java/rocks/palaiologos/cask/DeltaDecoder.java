...
import rocks.palaiologos.cask.xz.DeltaOptions;
...
class DeltaDecoder extends AbstractCoder {
    ...
    InputStream decode(final String archiveName, final InputStream in, final long uncompressedLength,
        ...
        return new DeltaOptions((int) getOptionsFromCoder(coder)).getInputStream(in);
    }
    ...
    Object getOptionsFromCoder(final Coder coder) {
