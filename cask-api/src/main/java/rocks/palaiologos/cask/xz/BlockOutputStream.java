...
class BlockOutputStream extends rocks.palaiologos.cask.xz.FinishableOutputStream {
    private final OutputStream out;
    private final rocks.palaiologos.cask.xz.CountingOutputStream outCounted;
    ...
    public BlockOutputStream(OutputStream out, FilterEncoder[] filters,
        ...
        outCounted = new rocks.palaiologos.cask.xz.CountingOutputStream(out);
