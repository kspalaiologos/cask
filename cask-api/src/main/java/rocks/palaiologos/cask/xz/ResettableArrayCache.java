 ...
 * @since 1.7
 */
public class ResettableArrayCache extends rocks.palaiologos.cask.xz.ArrayCache {
     ...
     */
    public ResettableArrayCache(rocks.palaiologos.cask.xz.ArrayCache arrayCache) {
