...
import rocks.palaiologos.cask.xz.index.IndexHash;
...
public class SingleXZInputStream extends InputStream {
     ...
     * @since 1.7
     */
    public SingleXZInputStream(InputStream in, rocks.palaiologos.cask.xz.ArrayCache arrayCache)
            throws IOException {
    ...
    SingleXZInputStream(InputStream in, int memoryLimit, boolean verifyCheck,
                        byte[] streamHeader, rocks.palaiologos.cask.xz.ArrayCache arrayCache)
            throws IOException {
