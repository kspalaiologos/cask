...
package rocks.palaiologos.cask.xz.lz;

import rocks.palaiologos.cask.xz.ArrayCache;

final class HC4 extends LZEncoder {
    private final rocks.palaiologos.cask.xz.lz.Hash234 hash;
    private final int[] chain;
    private final rocks.palaiologos.cask.xz.lz.Matches matches;
    ...
    static int getMemoryUsage(int dictSize) {
        return rocks.palaiologos.cask.xz.lz.Hash234.getMemoryUsage(dictSize) + dictSize / (1024 / 4) + 10;
    }
    ...
    HC4(int dictSize, int beforeSizeMin, int readAheadMax,
        ...
        hash = new rocks.palaiologos.cask.xz.lz.Hash234(dictSize, arrayCache);
        ...
        matches = new rocks.palaiologos.cask.xz.lz.Matches(niceLen - 1);
