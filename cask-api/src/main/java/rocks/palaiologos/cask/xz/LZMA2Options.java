...
import rocks.palaiologos.cask.xz.lzma.LZMAEncoder;
...
public class LZMA2Options extends FilterOptions {
     ...
     * use {@link rocks.palaiologos.cask.xz.LZMA2InputStream} directly.
     */
    ...
    public LZMA2Options() {
        ...
        } catch (rocks.palaiologos.cask.xz.UnsupportedOptionsException e) {
            assert false;
     ...
     *
     * @throws rocks.palaiologos.cask.xz.UnsupportedOptionsException
     *                          <code>preset</code> is not supported
     */
    public LZMA2Options(int preset) throws rocks.palaiologos.cask.xz.UnsupportedOptionsException {
        setPreset(preset);
    }
     ...
     *                          <code>preset</code> is not supported
     */
    public void setPreset(int preset) throws rocks.palaiologos.cask.xz.UnsupportedOptionsException {
        if (preset < 0 || preset > 9)
            throw new rocks.palaiologos.cask.xz.UnsupportedOptionsException(
     ...
     */
    public void setDictSize(int dictSize) throws rocks.palaiologos.cask.xz.UnsupportedOptionsException {
     ...
     *                          are invalid
     */
    public void setLcLp(int lc, int lp) throws rocks.palaiologos.cask.xz.UnsupportedOptionsException {
     ...
     *                          exceed LC_LP_MAX
     */
    public void setLc(int lc) throws rocks.palaiologos.cask.xz.UnsupportedOptionsException {
        setLcLp(lc, lp);
    }
     ...
     *                          exceed LC_LP_MAX
     */
    public void setLp(int lp) throws rocks.palaiologos.cask.xz.UnsupportedOptionsException {
        setLcLp(lc, lp);
    }
     ...
     */
    public void setPb(int pb) throws rocks.palaiologos.cask.xz.UnsupportedOptionsException {
        if (pb < 0 || pb > PB_MAX)
            throw new rocks.palaiologos.cask.xz.UnsupportedOptionsException(
     ...
     */
    public void setMode(int mode) throws rocks.palaiologos.cask.xz.UnsupportedOptionsException {
     ...
     */
    public void setNiceLen(int niceLen) throws rocks.palaiologos.cask.xz.UnsupportedOptionsException {
     ...
     */
    public void setMatchFinder(int mf) throws rocks.palaiologos.cask.xz.UnsupportedOptionsException {
    ...
    public int getEncoderMemoryUsage() {
        return (mode == MODE_UNCOMPRESSED)
               ? rocks.palaiologos.cask.xz.UncompressedLZMA2OutputStream.getMemoryUsage()
               : rocks.palaiologos.cask.xz.LZMA2OutputStream.getMemoryUsage(this);
    }
    ...
    public rocks.palaiologos.cask.xz.FinishableOutputStream getOutputStream(FinishableOutputStream out,
        ...
        if (mode == MODE_UNCOMPRESSED)
            return new rocks.palaiologos.cask.xz.UncompressedLZMA2OutputStream(out, arrayCache);

        return new rocks.palaiologos.cask.xz.LZMA2OutputStream(out, this, arrayCache);
    }
     ...
     * to {@link rocks.palaiologos.cask.xz.LZMA2InputStream#getMemoryUsage(int)} if the dictionary size
     ...
     * {@link rocks.palaiologos.cask.xz.LZMA2InputStream#getMemoryUsage} directly to get raw decoder
     * memory requirements.
     */
    public int getDecoderMemoryUsage() {
        ...
        d |= d >>> 8;
        d |= d >>> 16;
        return rocks.palaiologos.cask.xz.LZMA2InputStream.getMemoryUsage(d + 1);
    }
    ...
    rocks.palaiologos.cask.xz.FilterEncoder getFilterEncoder() {
        return new rocks.palaiologos.cask.xz.LZMA2Encoder(this);
    }
