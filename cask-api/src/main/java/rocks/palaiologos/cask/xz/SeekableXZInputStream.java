...
import rocks.palaiologos.cask.xz.common.StreamFlags;
import rocks.palaiologos.cask.xz.check.Check;
import rocks.palaiologos.cask.xz.index.IndexDecoder;
import rocks.palaiologos.cask.xz.index.BlockInfo;
...
public class SeekableXZInputStream extends SeekableInputStream {
     ...
     */
    private final rocks.palaiologos.cask.xz.ArrayCache arrayCache;
     ...
     *
     * @throws rocks.palaiologos.cask.xz.CorruptedInputException
     ...
     * @since 1.7
     */
    public SeekableXZInputStream(SeekableInputStream in, rocks.palaiologos.cask.xz.ArrayCache arrayCache)
            throws IOException {
     ...
     *                          options not supported by this implementation
     *
     * @throws rocks.palaiologos.cask.xz.MemoryLimitException
    ...
    public SeekableXZInputStream(SeekableInputStream in, int memoryLimit,
                                 boolean verifyCheck)
            throws IOException {
        this(in, memoryLimit, verifyCheck, rocks.palaiologos.cask.xz.ArrayCache.getDefaultCache());
    }
     ...
     */
    public SeekableXZInputStream(SeekableInputStream in, int memoryLimit,
                                 boolean verifyCheck, rocks.palaiologos.cask.xz.ArrayCache arrayCache)
            throws IOException {
        ...
        {
            in.seek(0);
            byte[] buf = new byte[rocks.palaiologos.cask.xz.XZ.HEADER_MAGIC.length];
        ...
        while (pos > 0) {
            ...
            if (pos < off)
                throw new rocks.palaiologos.cask.xz.CorruptedInputException("XZ Index indicates "
            ...
            if (uncompressedSize < 0)
                throw new rocks.palaiologos.cask.xz.UnsupportedOptionsException("XZ file is too big");
    ...
    public int read(byte[] buf, int off, int len) throws IOException {
        ...
        try {
            ...
            if (e instanceof EOFException)
                e = new rocks.palaiologos.cask.xz.CorruptedInputException();
    ...
    private void initBlockDecoder() throws IOException {
        try {
            ...
            throw new MemoryLimitException(
                    e.getMemoryNeeded() + indexMemoryUsage,
                    memoryLimit + indexMemoryUsage);
        } catch (rocks.palaiologos.cask.xz.IndexIndicatorException e) {
