...
import rocks.palaiologos.cask.xz.lz.LZDecoder;
import rocks.palaiologos.cask.xz.rangecoder.RangeDecoderFromStream;
import rocks.palaiologos.cask.xz.lzma.LZMADecoder;
...
public class LZMAInputStream extends InputStream {
    ...
    private rocks.palaiologos.cask.xz.ArrayCache arrayCache;
    ...
    public static int getMemoryUsage(int dictSize, byte propsByte)
            throws rocks.palaiologos.cask.xz.UnsupportedOptionsException, rocks.palaiologos.cask.xz.CorruptedInputException {
        ...
        if (props > (4 * 5 + 4) * 9 + 8)
            throw new rocks.palaiologos.cask.xz.CorruptedInputException("Invalid LZMA properties byte");
     ...
     * @since 1.7
     */
    public LZMAInputStream(InputStream in, rocks.palaiologos.cask.xz.ArrayCache arrayCache)
            throws IOException {
    ...
    public LZMAInputStream(InputStream in, int memoryLimit)
            throws IOException {
        this(in, memoryLimit, rocks.palaiologos.cask.xz.ArrayCache.getDefaultCache());
    }
     ...
     */
    public LZMAInputStream(InputStream in, int memoryLimit,
                           rocks.palaiologos.cask.xz.ArrayCache arrayCache) throws IOException {
    ...
    public LZMAInputStream(InputStream in, long uncompSize, byte propsByte,
        ...
        initialize(in, uncompSize, propsByte, dictSize, null,
                   rocks.palaiologos.cask.xz.ArrayCache.getDefaultCache());
    }
    ...
    public int read(byte[] buf, int off, int len) throws IOException {
        ...
        try {
            ...
            while (len > 0) {
                ...
                try {
                    lzma.decode();
                } catch (rocks.palaiologos.cask.xz.CorruptedInputException e) {
