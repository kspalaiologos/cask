...
import rocks.palaiologos.cask.xz.common.Util;
import rocks.palaiologos.cask.xz.XZIOException;

abstract class IndexBase {
    private final rocks.palaiologos.cask.xz.XZIOException invalidIndexException;
    long blocksSum = 0;
    long uncompressedSum = 0;
    long indexListSize = 0;
    long recordCount = 0;

    IndexBase(rocks.palaiologos.cask.xz.XZIOException invalidIndexException) {
