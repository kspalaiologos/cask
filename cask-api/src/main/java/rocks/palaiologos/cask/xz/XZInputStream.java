 ...
 *
 * @see rocks.palaiologos.cask.xz.SingleXZInputStream
 */
public class XZInputStream extends InputStream {
    ...
    private rocks.palaiologos.cask.xz.SingleXZInputStream xzIn;
     ...
     *                          data is read
     *
     * @throws rocks.palaiologos.cask.xz.XZFormatException
     ...
     * @since 1.7
     */
    public XZInputStream(InputStream in, rocks.palaiologos.cask.xz.ArrayCache arrayCache)
            throws IOException {
    ...
    public XZInputStream(InputStream in, int memoryLimit, boolean verifyCheck,
        ...
        this.xzIn = new rocks.palaiologos.cask.xz.SingleXZInputStream(in, memoryLimit, verifyCheck,
                                            arrayCache);
    }
     ...
     *
     * @throws rocks.palaiologos.cask.xz.XZIOException if the stream has been closed
     *
     * @throws      EOFException
    ...
    public int read(byte[] buf, int off, int len) throws IOException {
        ...
        if (in == null)
            throw new rocks.palaiologos.cask.xz.XZIOException("Stream closed");
