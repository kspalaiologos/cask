...
package rocks.palaiologos.cask.xz.common;

import java.io.InputStream;
import java.io.IOException;
import java.io.EOFException;
import java.util.zip.CRC32;
import rocks.palaiologos.cask.xz.XZ;
import rocks.palaiologos.cask.xz.CorruptedInputException;
import rocks.palaiologos.cask.xz.UnsupportedOptionsException;
import rocks.palaiologos.cask.xz.XZFormatException;
...
public class DecoderUtil extends Util {
    ...
    public static StreamFlags decodeStreamHeader(byte[] buf)
        ...
        if (!isCRC32Valid(buf, XZ.HEADER_MAGIC.length, 2,
            ...
            throw new rocks.palaiologos.cask.xz.CorruptedInputException("XZ Stream Header is corrupt");
    ...
    public static StreamFlags decodeStreamFooter(byte[] buf)
        ...
        if (buf[10] != XZ.FOOTER_MAGIC[0] || buf[11] != XZ.FOOTER_MAGIC[1]) {
            ...
            throw new rocks.palaiologos.cask.xz.CorruptedInputException("XZ Stream Footer is corrupt");
        }
