...
import rocks.palaiologos.cask.xz.MemoryLimitException;
import rocks.palaiologos.cask.xz.SeekableInputStream;
...
public class IndexDecoder extends IndexBase {
    ...
    public IndexDecoder(SeekableInputStream in, StreamFlags streamFooterFlags,
            ...
            throws IOException {
        super(new rocks.palaiologos.cask.xz.CorruptedInputException("XZ Index is corrupt"));
