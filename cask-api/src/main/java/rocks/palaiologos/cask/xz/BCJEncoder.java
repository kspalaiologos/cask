...
class BCJEncoder extends BCJCoder implements FilterEncoder {
    private final rocks.palaiologos.cask.xz.BCJOptions options;
    private final long filterID;
    private final byte[] props;

    BCJEncoder(rocks.palaiologos.cask.xz.BCJOptions options, long filterID) {
        ...
        this.options = (rocks.palaiologos.cask.xz.BCJOptions)options.clone();
    }
