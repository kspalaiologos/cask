...
public abstract class LZMAEncoder extends LZMACoder {
    ...
    final rocks.palaiologos.cask.xz.lz.LZEncoder lz;
    ...
    LZMAEncoder(RangeEncoder rc, rocks.palaiologos.cask.xz.lz.LZEncoder lz,
    ...
    rocks.palaiologos.cask.xz.lz.Matches getMatches() {
        ++readAhead;
