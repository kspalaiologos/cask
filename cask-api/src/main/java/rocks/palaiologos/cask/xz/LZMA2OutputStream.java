...
import rocks.palaiologos.cask.xz.rangecoder.RangeEncoderToBuffer;
import rocks.palaiologos.cask.xz.lzma.LZMAEncoder;

class LZMA2OutputStream extends rocks.palaiologos.cask.xz.FinishableOutputStream {
    static final int COMPRESSED_SIZE_MAX = 64 << 10;

    private final rocks.palaiologos.cask.xz.ArrayCache arrayCache;

    private rocks.palaiologos.cask.xz.FinishableOutputStream out;
