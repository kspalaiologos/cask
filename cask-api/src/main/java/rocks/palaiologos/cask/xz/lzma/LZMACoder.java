...
import rocks.palaiologos.cask.xz.rangecoder.RangeCoder;
...
abstract class LZMACoder {
    ...
    final rocks.palaiologos.cask.xz.lzma.State state = new rocks.palaiologos.cask.xz.lzma.State();

    final short[][] isMatch = new short[rocks.palaiologos.cask.xz.lzma.State.STATES][POS_STATES_MAX];
    final short[] isRep = new short[rocks.palaiologos.cask.xz.lzma.State.STATES];
    final short[] isRep0 = new short[rocks.palaiologos.cask.xz.lzma.State.STATES];
    final short[] isRep1 = new short[rocks.palaiologos.cask.xz.lzma.State.STATES];
    final short[] isRep2 = new short[rocks.palaiologos.cask.xz.lzma.State.STATES];
    final short[][] isRep0Long = new short[rocks.palaiologos.cask.xz.lzma.State.STATES][POS_STATES_MAX];
