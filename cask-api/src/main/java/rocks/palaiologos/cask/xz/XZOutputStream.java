...
import rocks.palaiologos.cask.xz.common.EncoderUtil;
import rocks.palaiologos.cask.xz.common.StreamFlags;
import rocks.palaiologos.cask.xz.check.Check;
import rocks.palaiologos.cask.xz.index.IndexEncoder;
...
public class XZOutputStream extends FinishableOutputStream {
    ...
    private rocks.palaiologos.cask.xz.BlockOutputStream blockEncoder = null;
    ...
    public XZOutputStream(OutputStream out, FilterOptions filterOptions)
            throws IOException {
        this(out, filterOptions, rocks.palaiologos.cask.xz.XZ.CHECK_CRC64);
    }
    ...
    public XZOutputStream(OutputStream out, FilterOptions filterOptions,
            ...
            throws IOException {
        this(out, filterOptions, rocks.palaiologos.cask.xz.XZ.CHECK_CRC64, arrayCache);
    }
     ...
     */
    public XZOutputStream(OutputStream out, FilterOptions filterOptions,
                          int checkType, rocks.palaiologos.cask.xz.ArrayCache arrayCache)
            throws IOException {
        this(out, new FilterOptions[] { filterOptions }, checkType,
             arrayCache);
    }
    ...
    public XZOutputStream(OutputStream out, FilterOptions[] filterOptions,
                          int checkType) throws IOException {
        this(out, filterOptions, checkType, rocks.palaiologos.cask.xz.ArrayCache.getDefaultCache());
    }
    ...
    public void updateFilters(FilterOptions[] filterOptions)
        ...
        if (blockEncoder != null)
            throw new rocks.palaiologos.cask.xz.UnsupportedOptionsException("Changing filter options "
        ...
        rocks.palaiologos.cask.xz.RawCoder.validate(newFilters);
        filters = newFilters;
    }
    ...
    public void write(byte[] buf, int off, int len) throws IOException {
        ...
        try {
            if (blockEncoder == null)
                blockEncoder = new rocks.palaiologos.cask.xz.BlockOutputStream(out, filters, check,
                                                     arrayCache);
    ...
    private void encodeStreamHeader() throws IOException {
        out.write(rocks.palaiologos.cask.xz.XZ.HEADER_MAGIC);
