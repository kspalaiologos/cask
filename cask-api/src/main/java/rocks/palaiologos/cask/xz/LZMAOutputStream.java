...
import rocks.palaiologos.cask.xz.rangecoder.RangeEncoderToStream;
...
public class LZMAOutputStream extends FinishableOutputStream {
    ...
    public LZMAOutputStream(OutputStream out, LZMA2Options options,
                            long inputSize)
            throws IOException {
        this(out, options, inputSize, rocks.palaiologos.cask.xz.ArrayCache.getDefaultCache());
    }
     ...
     */
    public LZMAOutputStream(OutputStream out, LZMA2Options options,
                            long inputSize, rocks.palaiologos.cask.xz.ArrayCache arrayCache)
            throws IOException {
    ...
    public LZMAOutputStream(OutputStream out, LZMA2Options options,
        ...
        this(out, options, useEndMarker, rocks.palaiologos.cask.xz.ArrayCache.getDefaultCache());
    }
