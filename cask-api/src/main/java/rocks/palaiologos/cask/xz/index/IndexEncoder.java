...
public class IndexEncoder extends IndexBase {
    private final ArrayList<rocks.palaiologos.cask.xz.index.IndexRecord> records
            = new ArrayList<rocks.palaiologos.cask.xz.index.IndexRecord>();

    public IndexEncoder() {
        super(new rocks.palaiologos.cask.xz.XZIOException("XZ Stream or its Index has grown too big"));
    }

    public void add(long unpaddedSize, long uncompressedSize)
            throws XZIOException {
        super.add(unpaddedSize, uncompressedSize);
        records.add(new rocks.palaiologos.cask.xz.index.IndexRecord(unpaddedSize, uncompressedSize));
    }
    ...
    public void encode(OutputStream out) throws IOException {
        ...
        // List of Records
        for (rocks.palaiologos.cask.xz.index.IndexRecord record : records) {
