...
final class Hash234 extends CRC32Hash {
    ...
    void normalize(int normalizationOffset) {
        rocks.palaiologos.cask.xz.lz.LZEncoder.normalize(hash2Table, HASH_2_SIZE, normalizationOffset);
        rocks.palaiologos.cask.xz.lz.LZEncoder.normalize(hash3Table, HASH_3_SIZE, normalizationOffset);
